...
public class NFeInfNFeDetImpostoICMSICMSPartTest {
    ...
    public void test2() throws Exception {
        JAXBContext context = JAXBContext.newInstance(NFeInfNFeDetImpostoICMSICMSPart.class);
        Unmarshaller unmarshaller = context.createUnmarshaller();
        NFeInfNFeDetImpostoICMSICMSPart obj =(NFeInfNFeDetImpostoICMSICMSPart) unmarshaller.unmarshal(new StringReader(XML));
