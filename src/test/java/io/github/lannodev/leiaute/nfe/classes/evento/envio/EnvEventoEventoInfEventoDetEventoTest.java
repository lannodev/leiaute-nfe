...
public class EnvEventoEventoInfEventoDetEventoTest {
    ...
    public void test2() throws Exception {
        JAXBContext context = JAXBContext.newInstance(EnvEventoEventoInfEventoDetEvento.class);
        Unmarshaller unmarshaller = context.createUnmarshaller();
        EnvEventoEventoInfEventoDetEvento obj =(EnvEventoEventoInfEventoDetEvento) unmarshaller.unmarshal(new StringReader(XML));
