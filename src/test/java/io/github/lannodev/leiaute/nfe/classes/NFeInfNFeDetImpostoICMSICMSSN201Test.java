...
public class NFeInfNFeDetImpostoICMSICMSSN201Test {
    ...
    public void test2() throws Exception {
        JAXBContext context = JAXBContext.newInstance(NFeInfNFeDetImpostoICMSICMSSN201.class);
        Unmarshaller unmarshaller = context.createUnmarshaller();
        NFeInfNFeDetImpostoICMSICMSSN201 obj =(NFeInfNFeDetImpostoICMSICMSSN201) unmarshaller.unmarshal(new StringReader(XML));
