...
public class NFeInfNFeTranspReboqueTest {
    ...
    public void test2() throws Exception {
        JAXBContext context = JAXBContext.newInstance(NFeInfNFeTranspReboque.class);
        Unmarshaller unmarshaller = context.createUnmarshaller();
        NFeInfNFeTranspReboque obj =(NFeInfNFeTranspReboque) unmarshaller.unmarshal(new StringReader(XML));
