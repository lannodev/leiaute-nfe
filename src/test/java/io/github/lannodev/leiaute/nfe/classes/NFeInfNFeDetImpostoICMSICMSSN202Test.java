...
public class NFeInfNFeDetImpostoICMSICMSSN202Test {
    ...
    public void test2() throws Exception {
        JAXBContext context = JAXBContext.newInstance(NFeInfNFeDetImpostoICMSICMSSN202.class);
        Unmarshaller unmarshaller = context.createUnmarshaller();
        NFeInfNFeDetImpostoICMSICMSSN202 obj =(NFeInfNFeDetImpostoICMSICMSSN202) unmarshaller.unmarshal(new StringReader(XML));
