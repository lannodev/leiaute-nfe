...
public class NFeInfNFeDetImpostoICMSICMSSN900Test {
    ...
    public void test2() throws Exception {
        JAXBContext context = JAXBContext.newInstance(NFeInfNFeDetImpostoICMSICMSSN900.class);
        Unmarshaller unmarshaller = context.createUnmarshaller();
        NFeInfNFeDetImpostoICMSICMSSN900 obj =(NFeInfNFeDetImpostoICMSICMSSN900) unmarshaller.unmarshal(new StringReader(XML));
