...
public class NFeInfNFeDetImpostoICMSICMS70Test {
    ...
    public void test2() throws Exception {
        JAXBContext context = JAXBContext.newInstance(NFeInfNFeDetImpostoICMSICMS70.class);
        Unmarshaller unmarshaller = context.createUnmarshaller();
        NFeInfNFeDetImpostoICMSICMS70 obj =(NFeInfNFeDetImpostoICMSICMS70) unmarshaller.unmarshal(new StringReader(XML));
