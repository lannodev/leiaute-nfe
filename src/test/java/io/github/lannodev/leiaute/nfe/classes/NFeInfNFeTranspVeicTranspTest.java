...
public class NFeInfNFeTranspVeicTranspTest {
    ...
    public void test2() throws Exception {
        JAXBContext context = JAXBContext.newInstance(NFeInfNFeTranspVeicTransp.class);
        Unmarshaller unmarshaller = context.createUnmarshaller();
        NFeInfNFeTranspVeicTransp obj =(NFeInfNFeTranspVeicTransp) unmarshaller.unmarshal(new StringReader(XML));
