...
public class NFeInfNFeDetImpostoICMSICMS90Test {
    ...
    public void test2() throws Exception {
        JAXBContext context = JAXBContext.newInstance(NFeInfNFeDetImpostoICMSICMS90.class);
        Unmarshaller unmarshaller = context.createUnmarshaller();
        NFeInfNFeDetImpostoICMSICMS90 obj =(NFeInfNFeDetImpostoICMSICMS90) unmarshaller.unmarshal(new StringReader(XML));
