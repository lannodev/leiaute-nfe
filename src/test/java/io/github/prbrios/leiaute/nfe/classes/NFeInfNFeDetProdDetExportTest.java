...
public class NFeInfNFeDetProdDetExportTest {
    ...
    public void test2() throws Exception {
        JAXBContext context = JAXBContext.newInstance(NFeInfNFeDetProdDetExport.class);
        Unmarshaller unmarshaller = context.createUnmarshaller();
        NFeInfNFeDetProdDetExport obj =(NFeInfNFeDetProdDetExport) unmarshaller.unmarshal(new StringReader(XML));
