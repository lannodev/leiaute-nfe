...
public class NFeInfNFeDetImpostoICMSICMSSN500Test {
    ...
    public void test2() throws Exception {
        JAXBContext context = JAXBContext.newInstance(NFeInfNFeDetImpostoICMSICMSSN500.class);
        Unmarshaller unmarshaller = context.createUnmarshaller();
        NFeInfNFeDetImpostoICMSICMSSN500 obj =(NFeInfNFeDetImpostoICMSICMSSN500) unmarshaller.unmarshal(new StringReader(XML));
