...
public class NFeInfNFeDetImpostoPISSTTest {
    ...
    public void test2() throws Exception {
        JAXBContext context = JAXBContext.newInstance(NFeInfNFeDetImpostoPISST.class);
        Unmarshaller unmarshaller = context.createUnmarshaller();
        NFeInfNFeDetImpostoPISST obj =(NFeInfNFeDetImpostoPISST) unmarshaller.unmarshal(new StringReader(XML));
