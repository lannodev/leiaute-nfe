...
public class NFeInfNFeDestEnderDestTest {
    ...
    public void test2() throws Exception {
        JAXBContext context = JAXBContext.newInstance(NFeInfNFeDestEnderDest.class);
        Unmarshaller unmarshaller = context.createUnmarshaller();
        NFeInfNFeDestEnderDest obj =(NFeInfNFeDestEnderDest) unmarshaller.unmarshal(new StringReader(XML));
