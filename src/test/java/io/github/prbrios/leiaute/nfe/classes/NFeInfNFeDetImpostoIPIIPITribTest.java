...
public class NFeInfNFeDetImpostoIPIIPITribTest {
    ...
    public void test2() throws Exception {
        JAXBContext context = JAXBContext.newInstance(NFeInfNFeDetImpostoIPIIPITrib.class);
        Unmarshaller unmarshaller = context.createUnmarshaller();
        NFeInfNFeDetImpostoIPIIPITrib obj =(NFeInfNFeDetImpostoIPIIPITrib) unmarshaller.unmarshal(new StringReader(XML));
